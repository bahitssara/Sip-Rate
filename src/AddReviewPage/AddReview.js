                            ...
                            <div className='field'>
                                ...
                                <select
                                    ...
                                    {this.context.beverages.map(bev =>
                                        <option key={bev.id} value={bev.id}>{bev.bev_name}</option>
                                    )}
                                </select>
                            </div>
                            <div className='field'>
                                <label htmlFor='choose-type'>
                                    Choose Type:
                                </label>
                                <select
                                    type='select'
                                    ...
                                    {this.context.beverages.map(bev =>
                                        <option key={bev.id} value={bev.bev_type}>{bev.bev_type}</option>
                                    )}
                                </select>
                            </div>
                            <div className='field'>
